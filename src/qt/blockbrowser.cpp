...
{
    if(Height > pindexBest->nHeight) { return "0x0000011700afc6de2c753c7a6761ace031978445897e5fe36c700aecc2a9c05a"; }
    if(Height < 0) { return "0x0000011700afc6de2c753c7a6761ace031978445897e5fe36c700aecc2a9c05a"; }
    int desiredheight;
...
{    
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " ctv");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " ctv");
    }
}
