...
"for example: alertnotify=echo %%s | mail -s \"creativecoin Alert\" admin@foo."
"com\n"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Send command to -server or creativecoind"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Specify pid file (default: creativecoind.pid)"),
